...
```java
- C:\Users\SoporteTI\IdeaProjects\LRBA-MX-JSPRK-EXAMEN-V00
| - local-execution
  | - database
...
- Folder **src** contains the java files:
  - **JobExamenBuilder.java**: Indicates the sources and targets the generated application
